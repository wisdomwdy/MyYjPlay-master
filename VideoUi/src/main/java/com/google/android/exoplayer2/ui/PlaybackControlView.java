...
public class PlaybackControlView extends FrameLayout {
    ...
    InterfaceUpdateProgress mInterfaceUpdateProgress;
    public void setOnUpdateProgressListener(InterfaceUpdateProgress interfaceUpdateProgress){
        this.mInterfaceUpdateProgress = interfaceUpdateProgress;
    }
    ...
    public void updateProgress() {
        ...
        if(mInterfaceUpdateProgress != null){
            mInterfaceUpdateProgress.updateDuration(duration);
        }
        if(mInterfaceUpdateProgress != null){
            mInterfaceUpdateProgress.updateProgress(position);
        }
        if (!isVisible() ){
            return;
        }
